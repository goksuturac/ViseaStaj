...
train_datapath = "\\ViseaStaj\\emotion_recognition_demo\\dataset\\train"
test_datapath = "ViseaStaj\\emotion_recognition_demo\\dataset\\test"
...
with open("ViseaStaj\\emotion_recognition_demo\\dataset\\train.txt", 'w') as x:
    for i in range(len(train_image_paths)):
        x.write(str(train_image_paths[i]))
        x.write('\n')

with open("ViseaStaj\\emotion_recognition_demo\\dataset\\test.txt", 'w') as x:
